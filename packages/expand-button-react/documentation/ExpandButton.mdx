...
import ExpandButtonExample, { expand-buttonExampleCode } from "./ExpandButtonExample";

<Ingress>Ingress med kort beskrivelse av komponenten</Ingress>

<ComponentExample component={ExpandButtonExample} codeExample={expand-buttonExampleCode} />
...
## Når bruker vi ExpandButton?

Før du bruker ExpandButton er det greit å ha tatt stilling til noen spørsmål:
