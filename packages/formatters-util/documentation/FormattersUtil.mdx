---
title: FormattersUtil
react: formatters-util-react
scss: formatters-util
group: edit me!
---

import FormattersUtilExample, { formattersUtilExampleCode } from "./FormattersUtilExample";

<Ingress>Ingress med kort beskrivelse av komponenten</Ingress>

<ComponentExample component={FormattersUtilExample} codeExample={formattersUtilExampleCode} />
...
## Når bruker vi FormattersUtil?

Før du bruker FormattersUtil er det greit å ha tatt stilling til noen spørsmål:
